...
namespace zen
{
    namespace data
    {
        ...
        void Vector<TYPE>::calculate_item_id_num_bits()
        {
            ...
            ZEN_ASSERT(m_item_id_num_bits <= sc_item_id_max_bits, "m_item_id_num_bits(", m_item_id_num_bits, ") > sc_item_id_max_bits(", sc_item_id_max_bits, ").");
        }
    ...
    namespace data
    {
        ...
        bool Vector<TYPE>::serialize_delta(const Element& element_reference, bitstream::Writer& out, bitstream::Writer& delta_bits) const
        {
            ...
            if (values_changed)
            {
                ...
                {
                    serializers::serialize_integer_ranged(m_item_id_num_bits, (size_t)0, sc_item_id_max_bits, sc_item_id_max_bitcount, out);
                }
        ...
        bool Vector<TYPE>::deserialize_delta(const Element& element_reference, bitstream::Reader& in, bitstream::Reader& delta_bits)
        {
            ...
            if (value_changed)
            {
                ...
                if (item_id_num_bits_changed)
                {
                    serializers::deserialize_integer_ranged(m_item_id_num_bits, (size_t)0, sc_item_id_max_bits, sc_item_id_max_bitcount, in);
                }
